...
public class DownloadStatusUpdater {
     ...
     *
     * @param longDownloadId the ID
     * @param connection     the http connection to use to check response headers.
     */
     ...
     *
     * @param downloadStatus the object tracking the download status of the given request.
     * @param longDownloadId download request id.
     * @param bytesRead      the bytes successfully downloaded.
     * @param totalBytes     total number of bytes if known, or -1 if not known.
     * @return true if progress broadcast should be sent, false otherwise.
     */
     ...
     *
     * @param longDownloadId the task of which to update progress
     ...
     *
     * @param longDownloadId    the id
     * @param withStatus        whether it worked or not
     * @param completionMessage the completion message if any
     * @param bytesRead         the bytes successfully downloaded
     * @param totalBytes        the total size of the entity to download
     * @param autoRestart       whether this was an automatic restart of something
     ...
     *
     * @param downloadStatus the corresponding downloadStatus object
     ...
     *
     * @param downloadId the downloadId this method will always return the same
     *                   mutex for
