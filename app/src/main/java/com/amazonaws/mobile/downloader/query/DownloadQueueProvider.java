...
public class DownloadQueueProvider extends ContentProvider {
     ...
     * @param projection    the columns desired in the output
     * @param selection     the "where" clause to use
     * @param selectionArgs variables to insert into the ? in the "where" clause
     ...
     * @param selectionArgs the variables to be inserted into the ? of the "where" clause
    ...
    /* package */static final class DatabaseHelper extends SQLiteOpenHelper {
         ...
         *
         * @param db the database in which to create the schema.
         */
        @Override
