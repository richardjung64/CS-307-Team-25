...
public class BasicDownloader implements DownloadTask.DownloadListener,
     ...
     *
     * @param aContext        the context to use for accessing the content provider etc
     * @param aPolicyProvider the download policy provider to use
     * @param aStatusUpdater  the download status updater to use
     */
     ...
     *
     * @param id the ID to look up and create the runnable for
     * @return the callable.
     */
     ...
     *
     * @param longDownloadId the ID
     * @param connection     the HttpUrlConnection containing response headers to examine.
     */
    @Override
