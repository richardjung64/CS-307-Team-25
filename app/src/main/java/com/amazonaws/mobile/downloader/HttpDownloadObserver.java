...
public class HttpDownloadObserver {
    ...
    /* package */
    static HttpDownloadObserver getDownloadById(final Context context, final long id) {
    ...
    /* package */
    static List<HttpDownloadObserver> getAllDownloadsByDownloadState(
    ...
    /* package */
    static List<HttpDownloadObserver> getAllDownloads(final Context context) {
