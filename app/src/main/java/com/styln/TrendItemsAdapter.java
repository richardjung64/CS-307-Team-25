...
public class TrendItemsAdapter extends RecyclerView.Adapter<TrendItemsAdapter.MyViewHolder> {
    ...
    public TrendItemsAdapter(Context mContext, List<ClothingDO> clothes) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new TrendItemsAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final TrendItemsAdapter.MyViewHolder holder, int position) {
