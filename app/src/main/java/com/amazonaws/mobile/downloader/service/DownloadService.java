...
public class DownloadService extends Service {
     ...
     *
     * @param startId the id of the request that's done.
     */
     ...
     * Enqueue a download.
     *
     * @param intent the intent to request a download.
     */
     ...
     * @param state the new value for the state column
     * @param flags the new value for the flags column
     */
     ...
     *
     * @param path the file path for download rows
     * @return download ids with file path started with path
     */
    ...
    /**
     * @param intent     The original intent to request a download.
     * @param downloadId The unique download id for this download request.
