...
public final class DownloadTask implements Callable<Boolean> {
     ...
     */
     /* package */
    static long getContentLengthFromHeader(final HttpURLConnection connection) {
        long result = -1L;
     ...
     *
     * @param withStatus        whether to report we worked or failed
     * @param completionMessage a message to describe the state further
     * @param bytesRead         the number of bytes successfully downloaded
     * @param total             the supposed total size of the download
     * @param ars               whether the task was a restart which was not initiated by user action
     * @param downloadError     error code with a DownloadError enum value
     */
     ...
     *
     * @param connection the HttpResponse to examine for the relevant headers
    ...
    public interface DownloadListener {
         ...
         *
         * @param downloadId the id of the download
         * @param connection the http connection containing the received headers.
         */
         ...
         *
         * @param downloadId the id of the download
         * @param bytesRead  the progress so far
         * @param totalBytes the total to be read (or -1 if not known)
         */
         ...
         * @param completionMessage extra details to be passed back to the caller
         * @param bytesRead         bytes read so far
         * @param totalBytes        total size of requested download
         * @param autoRestart       whether the task was a restart which was not initiated by user action
         * @param downloadError     error code with a DownloadError enum value
         */
    ...
    public static final class Builder {
         ...
         * Create a new instance.
         *
         * @param downloadId the id, which is required for all requests.
         */
         ...
         * Set the total bytes.
         *
         * @param total the total bytes to set
         * @return the builder
         */
